            ...
            <main className="w-full max-w-6xl p-5">
                <section className="flex flex-col md:flex-row md:space-x-10 mb-10">
                    <div className="flex-shrink-0">
                        <Image src={"/album2.svg"} width={400} height={400} alt="Album Image"/>
                    </div>
                    <div className="flex-grow mt-5 md:mt-0">
                        <div className="bg-gray-100 p-5 rounded-lg shadow-lg">
                            <h2 className="text-2xl font-bold">Bliss</h2>
              <h3 className="text-xl">Dream Catcher</h3>
              <div className="mt-5 bg-black text-white p-5 rounded-lg shadow-lg">
                ...
                <div className="mt-4 flex justify-center">
                  <div className="text-center">
                    <div className="text-5xl">Raffle is Over</div>
                  </div>
                </div>
                <div className="mt-5 bg-black text-white p-5 rounded-lg shadow-lg">
                ...
                <button className="mt-5 w-full bg-indigo-400 text-white py-2 rounded-lg" onClick={openModal}>Check Result</button>
              </div>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-100 p-3 rounded-lg shadow-lg">
               <Image src={"/artist2-1.svg"} width={400} height={400} alt="ruby"/>
              <div className="mt-3 text-center">Ruby</div>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg shadow-lg">
               <Image src={"/artist2-2.svg"} width={400} height={400} alt="emerald"/>
              <div className="mt-3 text-center">Emerald</div>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg shadow-lg">
               <Image src={"/artist2-3.svg"} width={400} height={400} alt="opal"/>
              <div className="mt-3 text-center">Opal</div>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg shadow-lg">
               <Image src={"/artist2-4.svg"} width={400} height={400} alt="topaz"/>
